...
<link href="https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/assets/owl.theme.default.min.css" rel="stylesheet" />
	...
	<div class="nk-wrap">
        ...
        <!-- <main class="nk-pages"> -->
            ...
            <section>
                <div class="gensis-exchange-bg">
                    <img src="images/gensis-exchange.jpg" alt="">
                </div>
            </section>
           
            <!-- // -->
            <section class="section products ov-h" id="gensis-ico-exchange">
                <div class="container">
                    <!-- Block @s -->
                        ...
                        <div class="row align-items-center justify-content-center ">
                                <div class=" col-md-6 ">
                                    <div class="nk-block-img">
                                        <img class="img-fluid " src="images/blockchain_exchange/blockchain_exchange_1.png" alt="gfx">
                                    </div> 
                                </div>
            ...
            <section class="section products-3 ov-h "  id="products_2222">
                <div class="container">
                        <div class="row align-items-center justify-content-center ">
                            ...
                            <div class=" col-md-6 ">
                                <div class="nk-block-img">
                                    <img class="img-fluid " src="images/blockchain_exchange/blockchain_exchange_2.png" alt="gfx">
                                </div> 
                            </div>
