                                            ...
                                            <div class="accordion-item accordion-item-s4 bg-theme tc-light">
                                                ...
                                                <div id="faq-67-1" class="collapse show" data-parent="#faq-67">
                                                    <div class="accordion-content">
                                                        ...
                                                        <p>Our wallet is an easy-to-use crypto mobile wallet application that will enable its users to send, receive, store, spend, exchange/swap and stake crypto tokens anytime as per their convenience. It is a user-friendly multi-crypto mobile application that is safe to use and is accessible to users across the globe via android and ios devices.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="accordion-item accordion-item-s4 bg-theme tc-light">
                                                ...
                                                <div id="faq-67-2" class="collapse" data-parent="#faq-67">
                                                    <div class="accordion-content">
                                                        <!-- <p>Once ICO period is launched, You can purchased Token with Etherum, Bitcoin or Litecoin. You can also tempor incididunt ut labore et dolore magna aliqua sed do eiusmod eaque ipsa.</p> -->
                                                        <p>Staking is the process of holding up crypto assets to support the network validate the transactions. The user will get to earn rewards in return for it. It is only available with cryptocurrencies that use the proof-of-stake model to process payments. </p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="accordion-item accordion-item-s4 bg-theme tc-light">
                                                ...
                                                <div id="faq-67-3" class="collapse" data-parent="#faq-67">
                                                    <div class="accordion-content">
                                                        <p>Genesis token (GBL) is the native utility token of Genesis Blockchain Labs. The token will be based on the Binance blockchain and can be used as an internal currency to trade in other cryptocurrencies.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="accordion-item accordion-item-s4 bg-theme tc-light">
                                                ...
                                                <div id="faq-67-4" class="collapse" data-parent="#faq-67">
                                                    <div class="accordion-content">
                                                        <p>Genesis token is based on Binance Smart Chain (BSC), the gas fee on BSC is minimal when compared to other platforms. We are offering an additional 50% discount on transaction fees for stocks and crypto. We also provide governance power to the token holders, they can vote on decisions regarding listings and changes to the app.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="accordion-item accordion-item-s4 bg-theme tc-light">
